...
# app.py inside the project2 folder
# Your main app routes and configurations go here
...
UPLOAD_FOLDER ='S:\\Project2\\uploads'
app.config['UPLOAD_FOLDER'] = UPLOAD_FOLDER

@app.route('/admin/upload_study_material', methods=['GET', 'POST'])
@admin_required
def admin_upload_study_material():
    if request.method == 'POST':
        ...
        if file:
            ...
            # Add the new study material to the database
    ...
    return render_template('admin_upload_study_material.html')
...
def admin_mark_attendance():
    # Assuming you have a function to fetch students from your database
    students =Student.query.all()   # You need to implement fetch_students() function
    return render_template('admin_mark_attendance.html', students=students)
